...
exports.help = {
    name: `autopurge`,
    category: `Moderation`,
    description: `Deletes every message after this command every given hours`,
    extendedDescription: `Deletes every message after this command every given hours`,
    usage: `autopurge [amount]`
};
